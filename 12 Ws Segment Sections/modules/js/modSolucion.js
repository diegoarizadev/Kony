function recuperarNoticias(){
  ...
  var seleccion2 = frmPrincipal.lstCategoria2.selectedKey;
    ...
    if (kony.string.equalsIgnoreCase(seleccion1, "vacio") && kony.string.equalsIgnoreCase(seleccion2, "vacio")){
      ...
      //Se envia un alert
      kony.ui.Alert({ message: "Debe seleccionar alguna categoria",alertType:constants. ALERT_TYPE_INFO, alertTitle:"Alerta.!",yesLabel:"OK"}, {});      
      ...
      var inputParams1 = {serviceID:"FoxNews", newsType:seleccion1};
      appmiddlewareinvokerasync(inputParams1, procesarResulado1);
      
      var inputParams2 = {serviceID:"FoxNews", newsType:seleccion2};
...
function procesarResulado1(estado, responseFoxNews1){
  ...
  if(estado == 400){
    if (responseFoxNews1.opstatus == 0 && responseFoxNews1 != null ) {
     ...
     kony.ui.Alert({ message: "N0rf3n ==> procesarResulado1 ==> Sin Servicio.! Estado " + responseFoxNews1.opstatus,alertType:constants. ALERT_TYPE_ERROR, alertTitle:"Error Opstatus",yesLabel:"OK"}, {});
  }
}
...
function procesarResulado2(estado, responseFoxNews2){
  ...
  if(estado == 400){
    if (responseFoxNews2.opstatus == 0 && responseFoxNews2 != null ) {
     ...
     //Se muestra el error generado por pantalla.
     kony.ui.Alert({ message: "N0rf3n ==> procesarResulado2 ==> Sin Servicio.! Estado " + responseFoxNews2.opstatus,alertType:constants. ALERT_TYPE_ERROR, alertTitle:"Error Opstatus",yesLabel:"OK"}, {});
  }
}
...
function mostrarDatasegmento(){
  ...
  if(segmentoDatos.length == 2 && segmentoDatos != null){
    ...
    frmPrincipal.segNoticias.widgetDataMap ={lblTituloNoticia:"titulo"};
    frmPrincipal.segNoticias.setVisibility(true);
