...
function cargarItems() {
    ...
    var contactos = [
        ...
        ["Amiguitas", [{
            contacto: "Juliana Velez"
        }, {
            contacto: "Jackelin Cardona"
        }, {
            contacto: "Pilar Ramirez"
        }]],
        ["Clientes", [{
            contacto: "Natalia Paris"
        }]]
    ]
    //Especificacion del mapeo de arreglo.
    frmPrincipal.segAgenda.widgetDataMap = {
...
function agregarContacto() {
    ...
    for (var i = 0; i < seglenght; i++) {
        ...
        if (seccion == grupo) {
            frmPrincipal.segAgenda.addDataAt({
                contacto: nombre
            }, 0, i);
    ...
    if (makeExisting == false) {
        frmPrincipal.segAgenda.addSectionAt([
            [grupo, [{
                contacto: nombre
            }]]
        ], 0);
