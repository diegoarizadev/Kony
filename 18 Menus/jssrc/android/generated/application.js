...
function appmiddlewareinvoker(inputParam, isBlocking, indicator, datasetID) {
    ...
    inputParam["platformver"] = "6.5.GA_v201507232010";
...
function callAppMenu() {
    var appMenu = [
        ["appmenu1", "Accounts", "acct.png", appmenu1_callback_seq0,
        {
            "showAsFlag": constants.MENUITEM_SHOW_AS_ACTION_NEVER
        }],
        ["appmenu2", "Settings", "settings.png", appmenu2_callback_seq0,
        {
            "showAsFlag": constants.MENUITEM_SHOW_AS_ACTION_NEVER
        }],
        ["appmenu3", "Pay Bills", "pay.png", appmenu3_callback_seq0,
        {
            "showAsFlag": constants.MENUITEM_SHOW_AS_ACTION_NEVER
        }]
    ];
    kony.application.createAppMenu("MenusAppMenu", appMenu, null, null);
    kony.application.setCurrentAppMenu("MenusAppMenu");
}