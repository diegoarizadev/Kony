...
function callAppMenu() {
    var appMenu = [
        ["service", "Servicio", "service.png", null,
        {
            "showAsFlag": constants.MENUITEM_SHOW_AS_ACTION_NEVER
        }],
        ["options", "Opciones", "options.png", null,
        {
            "showAsFlag": constants.MENUITEM_SHOW_AS_ACTION_NEVER
        }],
        ["settings", "Confi", "settings.png", null,
        {
            "showAsFlag": constants.MENUITEM_SHOW_AS_ACTION_NEVER
        }],
        ["more", "Mas", "more.png", null,
        {
            "showAsFlag": constants.MENUITEM_SHOW_AS_ACTION_NEVER
        }]
    ];
    kony.application.createAppMenu("ApiDistintivoAppMenu", appMenu, null, null);
    kony.application.setCurrentAppMenu("ApiDistintivoAppMenu");
}